...
export interface TiendanubeGetProducts {
    "id": number,
    "name": PT,
    "description": PT,
    "handle": PT,
    ...
    "created_at": string
    "updated_at": string
    "variants": TiendanubeProductsVariants[],
    "tags": string
    "images": ProductsImages[],
    "categories": ProductsCategorys[]
}
...
interface TiendanubeProductsVariants {
    "id": number,
    "image_id": number,
    "product_id": number,
    "position": number,
    ...
    "cost": null,
    "visible": true,
    "inventory_levels": VariantsInventoryLevels[]
}

interface VariantsInventoryLevels {
    "id": number,
    "variant_id": number,
    "location_id": string
    "stock": null
