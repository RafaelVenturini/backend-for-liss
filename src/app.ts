...
export function buildApp() {
    ...
    app.register(swagger, {
        openapi: {
            info: {title: "Backliss API", version: "1.0.0", description: "Backend for liss"},
            tags: [
                {
                    name: 'Argos - Fashion',
                    description: 'Utilidades para aplicações envolvendo Argos, relacionado ao fashion'
                },
                {name: 'Database', description: 'Relacionados a alterações no banco de dados'},
                {name: 'Front Utils', description: 'Facilidades para o front-end sem ter que pensar muito'},
                {name: 'Health', description: 'Testes de segurança para saúde do backend'},
